...
Liens directs vers la page de preuves RNCP (version recruteur) :
- [RNCP BC01](rncp_preuves_p12.html#rncp-bc01)
- [RNCP BC02](rncp_preuves_p12.html#rncp-bc02)
- [RNCP BC03](rncp_preuves_p12.html#rncp-bc03)
- [RNCP BC04](rncp_preuves_p12.html#rncp-bc04)
- [RNCP BC05](rncp_preuves_p12.html#rncp-bc05)
...
> **Preuve** : [Section RNCP BC01 du notebook](rncp_preuves_p12.html#rncp-bc01)
...
|----------------------|-----------------------|-------------------------|------------|
| **Identifier et collecter** | Utilisation du **dataset ONFM** (images de billets + labels) en respectant les normes EMV. | [Section RNCP BC02](rncp_preuves_p12.html#rncp-bc02) | [Notebook](rncp_preuves_p12.html#rncp-bc02) |
| **Extraire et agréger** | Nettoyage des données : gestion des **valeurs manquantes**, suppression des doublons. | [Section RNCP BC02](rncp_preuves_p12.html#rncp-bc02) | [Notebook](rncp_preuves_p12.html#rncp-bc02) |
| **Explorer et pré-traiter** | **Feature Engineering** : sélection et préparation des variables pour la classification. | [Section RNCP BC02](rncp_preuves_p12.html#rncp-bc02) | [Notebook](rncp_preuves_p12.html#rncp-bc02) |
| **Vérifier la cohérence** | Vérification de la **fiabilité des données** (statistiques descriptives, distributions). | [Section RNCP BC02](rncp_preuves_p12.html#rncp-bc02) | [Notebook](rncp_preuves_p12.html#rncp-bc02) |
| **Traiter les données manquantes** | Imputation des valeurs manquantes (moyenne, médiane) et gestion des outliers. | [Section RNCP BC02](rncp_preuves_p12.html#rncp-bc02) | [Notebook](rncp_preuves_p12.html#rncp-bc02) |
| **Analyse temporelle** | *Non applicable* (pas de séries temporelles dans P12). | - | - |
| **Analyse univariée/multivariée** | Analyse des **distributions** (histogrammes, boxplots) et **corrélations** entre features. | [Section RNCP BC02](rncp_preuves_p12.html#rncp-bc02) | [Notebook](rncp_preuves_p12.html#rncp-bc02) |
...
| **Compétence RNCP** | **Ce que j’ai fait** | **Section du Notebook** | **Preuve** |
|----------------------|-----------------------|-------------------------|------------|
| **Solution de visualisation** | Création de **graphiques adaptés** (histogrammes, boxplots, matrice de corrélation) avec Matplotlib/Seaborn. | [Section RNCP BC03](rncp_preuves_p12.html#rncp-bc03) | [Notebook](rncp_preuves_p12.html#rncp-bc03) |
| **Graphiques accessibles** | Respect des **bonnes pratiques** (titres, légendes, couleurs contrastées). | [Section RNCP BC03](rncp_preuves_p12.html#rncp-bc03) | [Notebook](rncp_preuves_p12.html#rncp-bc03) |
| **Créer un tableau de bord** | *Non applicable* (pas de tableau de bord interactif dans P12). | - | - |
| **Reporting des tendances** | **Interprétation des graphiques** (ex: "La distribution des probabilités montre une séparation nette entre vrais et faux billets"). | [Section RNCP BC03](rncp_preuves_p12.html#rncp-bc03) | [Notebook](rncp_preuves_p12.html#rncp-bc03) |
| **Récit des résultats** | **Synthèse narrative** des résultats dans le notebook (cellules Markdown). | [Section RNCP BC03](rncp_preuves_p12.html#rncp-bc03) | [Notebook](rncp_preuves_p12.html#rncp-bc03) |
| **Présenter les résultats** | **Adaptation du contenu** pour un public technique (ONFM) et non-technique (slides séparés). | [Section RNCP BC03](rncp_preuves_p12.html#rncp-bc03) | [Notebook](rncp_preuves_p12.html#rncp-bc03) + [Dépôt GitHub](https://github.com/ferialzamoun-afk/P12) |
...
| **Organiser un projet data** | **Structuration du notebook** en sections claires (EDA, Modélisation, Évaluation). | [Notebook RNCP BC04](rncp_preuves_p12.html#rncp-bc04) | [Dépôt GitHub](https://github.com/ferialzamoun-afk/P12) |
| **Ateliers de formation** | *Non applicable* (pas d’atelier dans P12). | - | - |
| **Gérer la documentation** | **Commentaires détaillés** dans le code et cellules Markdown explicatives. | [Notebook RNCP BC04](rncp_preuves_p12.html#rncp-bc04) | [Dépôt GitHub](https://github.com/ferialzamoun-afk/P12) |
| **Adapter sa posture** | **Positionnement comme consultante** : explications claires pour l’ONFM. | [Section RNCP BC04](rncp_preuves_p12.html#rncp-bc04) | [Notebook](rncp_preuves_p12.html#rncp-bc04) |
...
| **Compétence RNCP** | **Ce que j’ai fait** | **Section du Notebook** | **Preuve** |
|----------------------|-----------------------|-------------------------|------------|
| **Analyses multivariées** | Étude des **corrélations entre features** (matrice de corrélation). | [Section RNCP BC05](rncp_preuves_p12.html#rncp-bc05) | [Notebook](rncp_preuves_p12.html#rncp-bc05) |
| **Réduction de dimension** | *Non applicable* (pas de PCA ou t-SNE dans P12). | - | - |
| **Tests statistiques** | **Validation croisée** et tests de robustesse (ex: test sur différents sous-ensembles). | [Section RNCP BC05](rncp_preuves_p12.html#rncp-bc05) | [Notebook](rncp_preuves_p12.html#rncp-bc05) |
| **Feature Engineering (non supervisé)** | Sélection des **variables pertinentes** pour la classification. | [Section RNCP BC05](rncp_preuves_p12.html#rncp-bc05) | [Notebook](rncp_preuves_p12.html#rncp-bc05) |
| **Entraîner un modèle** | **Classification binaire** avec Scikit-learn (Logistic Regression). | [Section RNCP BC05](rncp_preuves_p12.html#rncp-bc05) | [Notebook](rncp_preuves_p12.html#rncp-bc05) |
| **Exploiter un modèle** | **Évaluation des performances** (matrice de confusion, métriques). | [Section RNCP BC05](rncp_preuves_p12.html#rncp-bc05) | [Notebook](rncp_preuves_p12.html#rncp-bc05) |
| **Choisir un modèle adapté** | Justification du choix du modèle retenu après comparaison. | [Section RNCP BC05](rncp_preuves_p12.html#rncp-bc05) | [Notebook](rncp_preuves_p12.html#rncp-bc05) |
