...
| --- | --- | --- |
| Données chargées | 825 (ERP) + 1 513 (Web) + 825 (Liaison) | [data_merging.py](src/data_merging.py) |
| Contrôles qualité | 18 points validés (11 OK, 4 à vérifier, 2 à documenter, 1 corrigé) | [quality_checks.py](src/quality_checks.py) |
| Stocks corrigés | 2 exceptions (stock < 0) identifiées et tracées | [stock_cleaning.py](src/stock_cleaning.py) |
| Rapprochement ERP/Web | 714 / 1 513 matches (47.2% → anomalies à investiguer) | [data_merging.py](src/data_merging.py) |
🔹 Phase II : KPI Business
| KPI | Valeur | Interprétation | Preuve |
| --- | --- | --- | --- |
| CA total | 143 680 EUR/mois (octobre 2026) | ✅ Revenue consolidée | [kpi_analysis.py](src/kpi_analysis.py) |
| Produits avec CA | 689 | ✅ Diversité du catalogue | [eda_analysis.py](src/eda_analysis.py) |
| Pareto 80% | Rang 435 | ⚠️ Catalogue large, pas fortement concentré | [courbe_pareto_80_20.html](output/dataviz/courbe_pareto_80_20.html) |
| Marge moyenne | 47.32% | ✅ Saine | [anomalies_prix_et_marges.html](output/dataviz/anomalies_prix_et_marges.html) |
| Stock / Rotation | 2.98 mois (moyenne) | ⚠️ À optimiser (92 ruptures de stock détectées) | [distribution_stocks.html](output/dataviz/distribution_stocks.html) |
| Anomalies détectées | 10 (3 prix invalides, 7 marges négatives) | 🚨 À investiguer | [anomalies_prix_et_marges.html](output/dataviz/anomalies_prix_et_marges.html) |
...
| Critères explicites | Tableau comparaison + méthodologie | [Notebook, Cellule 2](notebooks/bottleneck_analyse_ameliore_final.ipynb) |
| Justifier les choix | Chaque cellule commence par "Pourquoi ?" | [Notebook complet](notebooks/bottleneck_analyse_ameliore_final.ipynb) |
